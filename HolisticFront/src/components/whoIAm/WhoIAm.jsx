...
function WhoIAm() {	
    return (
        ...
        <section>
            ...
            <section className="text_quienSoy">
                <p>Yo era una mujer que luchaba con problemas hormonales, resistencia a la insulina, falta de menstruación, acné, aumento de peso, caída excesiva del cabello, falta de sueño, fatiga extrema, estrés crónico y ansiedad.</p>

                <p>Estaba confusa, cansada y muy decepcionada.</p>

                <p>Tardaron mucho en diagnosticarme el síndrome de ovario poliquístico y el único consejo que me dieron fue que adelgazara y tomara una píldora anticonceptiva el resto de mi vida. Yo era una mujer que no sabía cómo mejorar mi salud física, mi estado emocional y mi bajo estado de ánimo.</p>

                <p>Pero yo no quería vivir así. Quería ser una mujer llena de energía, sentirme guapa y volver a ser feliz. Así que emprendí este viaje para resolver mis problemas, porque creo que tenemos el poder de transformar nuestras vidas.</p>

                <p>Cometí muchos errores, fui de un extremo a otro. De la alimentación restrictiva a los atracones, de la dieta vegana a la ceto, de no moverme en absoluto a los entrenamientos extremos. Nada parecía funcionar... Hasta que encontré el equilibrio adecuado y la conexión entre mis emociones y mi cuerpo.</p>
